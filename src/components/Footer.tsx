...
const Footer = () => {
  return (
    <motion.section
      ...
      className="relative max-w-7xl mx-auto px-4 flex justify-center items-center h-20" // Ensure some height
    >
      {/* Fading top border line left/right */}
      <div className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-foreground/30 to-transparent z-0" />
